...
const CHANGED_FILE_TEST_MAP = [
  ...
  { pattern: /^scripts\/material-/, commandId: 'focused.material-ci', reason: 'material tooling changed' },
  { pattern: /^app\/src\/art-pipeline\/(?:material-system|schema\/material-system)/, commandId: 'focused.material-ci', reason: 'material contract changed' },
  { pattern: /^app\/src\/components\/board\/(?:ThreeBoard|MaterialPreviewScene|surfaceCatalog|lightingRigs|boardQuality)/, commandId: 'focused.material-ci', reason: 'material runtime changed' },
  { pattern: /^app\/public\/images\/art\/materials\//, commandId: 'focused.material-ci', reason: 'material assets changed' },

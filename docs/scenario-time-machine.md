...
- **Health score** is explainable and combines Oracle score, confidence, setup fidelity, simulator life score, and penalties for flat turns, invalid actions, zero-stat collapse, failed gates, and rejected changes.

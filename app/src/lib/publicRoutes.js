...
export const DISCOVERY_TOPICS = [
  {
    ...
    name: 'Turn-Based Board Game',
    description: 'Turn-based board game scenarios where every action changes pressure, route shape, and recovery chances.',
    tags: ['turn-based', 'board-game', 'strategy'],
  },
  {
...
const STATIC_ROUTES = [
  {
    ...
    type: 'home',
    title: 'Xenovoya',
    description: 'Play and tune Xenovoya, a turn-based expedition board game about artifacts, escape pressure, and living board-state decisions.',
    priority: 1,
    changefreq: 'weekly',
  },
  {
  ...
  },
  {
    ...
    type: 'play',
    title: 'Play Xenovoya',
    description: 'Start a seedable public Xenovoya run and see if the expedition can find artifacts, recover, and escape.',
    priority: 0.92,
    changefreq: 'weekly',
  },
  {
  ...
  },
  {
    ...
    description: 'Browse Xenovoya scenarios by pressure, difficulty, player count, and public readiness.',
    priority: 0.88,
    changefreq: 'weekly',
  },
  {
  ...
  },
  {
    ...
    description: 'Draft a local Xenovoya scenario, tune its desired feeling, and test it as a playable run.',
    priority: 0.66,
    changefreq: 'monthly',
  },
];

...
export const DISCOVERY_TOPICS = [
  ...
  },
  {
    ...
    description: 'Scenario tuning and outcome learning powered by the same rules path as playable Xenovoya.',
...
const STATIC_ROUTES = [
  ...
  },
  {
    ...
    type: 'play',
    title: 'Play Xenovoya',
    description: 'Start a seedable Xenovoya run and see if the expedition can reveal the map, recover value, and escape alive.',
    priority: 0.92,
    changefreq: 'weekly',
  },
  {
  ...
  },
  {
    ...
    description: 'Draft a local Xenovoya expedition, tune its desired feeling, and test it as a playable shared survey.',
    priority: 0.66,
    changefreq: 'monthly',
  },
];

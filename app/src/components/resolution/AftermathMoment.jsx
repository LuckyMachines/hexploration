  ...
  return (
    <div className={`rounded border px-4 py-3 ${aftermathToneClass(moment.tone)}`}>
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <span className="rounded border border-current/30 bg-exp-dark/25 px-2 py-1 font-mono text-[11px] uppercase tracking-[0.14em]">
      ...
      <div className="mt-3 grid gap-2 lg:grid-cols-[1fr_1fr]">
        <div className="rounded border border-current/20 bg-exp-dark/25 px-3 py-2">
          <p className="font-mono text-[11px] uppercase tracking-[0.16em] opacity-75">
            Why it matters
          </p>

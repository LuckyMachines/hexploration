...
contract XenovoyaSessionForwarder is EIP712 {
    ...
    event RelayedActionSubmitted(address indexed player, address indexed signer, address indexed relayer, uint256 nonce);
    ...
    function _submitSignedAction(RelayedAction calldata action) internal {
        ...
        emit RelayedActionSubmitted(action.player, signer, msg.sender, action.nonce);
    }
